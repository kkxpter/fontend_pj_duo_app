...
import 'package:flutter_utilities2/pages/update2_rider.dart';
import 'package:google_fonts/google_fonts.dart';

class MapRider2 extends StatefulWidget {
  const MapRider2({super.key});

  @override
  State<MapRider2> createState() => _MapRider2();
}

class _MapRider2 extends State<MapRider2> {
  @override
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Update2()),
                );
              },

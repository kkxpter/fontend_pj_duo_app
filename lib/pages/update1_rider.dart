...
import 'package:flutter_utilities2/pages/map_rider2.dart';
...
class Update1 extends StatefulWidget {
  ...
  @override
  State<Update1> createState() => _Update1();
}

class _Update1 extends State<Update1> {
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.of(context).push( // เปลี่ยนไปหน้า map2.dart
                  MaterialPageRoute(builder: (context) => const MapRider2()),
                );
              },
